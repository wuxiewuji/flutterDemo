...
class HomeDrawerHeader extends StatefulWidget {
  const HomeDrawerHeader({ Key key, this.light }) : super(key: key);

  final bool light;

  @override
  _HomeDrawerHeaderState createState() => new _HomeDrawerHeaderState();
}
...
class HomeDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> allDrawerItems = <Widget>[
      new HomeDrawerHeader(light: useLightTheme),
      lightThemeItem,
      darkThemeItem,
      const Divider(),
      mountainViewItem,
